    ...
    <footer className="border-t-4 border-neon-green/40 bg-card">
      <div className="max-w-6xl mx-auto px-4 py-10 grid sm:grid-cols-2 gap-6 items-center">
        <div>
          ...
          <div className="font-mono-retro text-base text-muted-foreground">{copy.footer.stack}</div>
        </div>
        <div className="flex sm:justify-end gap-3 flex-wrap">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="font-pixel text-[9px] px-3 py-2 bg-background text-neon-yellow pixel-border-yellow pixel-hover"
          >
            GITHUB
          </a>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="font-pixel text-[9px] px-3 py-2 bg-background text-neon-cyan pixel-border-cyan pixel-hover"
          >
            LINKEDIN
          </a>
          <a
            href={profileLinks.email}
            className="font-pixel text-[9px] px-3 py-2 bg-background text-neon-magenta pixel-border-magenta pixel-hover"
          >
            EMAIL
          </a>
        </div>
