...
const PROJECTS = [
  ...
  },
  {
    ...
    summary: "Digital signature and document workflow platform for secure, legally valid online agreements.",
    problem: "Companies need to send, sign and manage documents without manual paperwork or fragmented tracking.",
    ...
    features: ["Document workflows", "Digital signatures", "API integrations", "Production support"],
